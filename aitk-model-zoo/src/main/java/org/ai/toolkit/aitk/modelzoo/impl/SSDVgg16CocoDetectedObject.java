...
@Component
public class SSDVgg16CocoDetectedObject implements ModelDefinition<Image, DetectedObjects> {

    @Override
    public String getId() {
        return "cv/object_detection/ssdVgg16Coco80";
    }

    @Override
    public ModelBasicInfo getModelBasicInfo() {
        return new ModelBasicInfo("SSD识别80种目标", "SSD目标检测", "/modelimage/model.jpg", "请输入一张图片");
    }
    ...
    public List<EngineEnum> getEngineList() {
        return Arrays.asList(EngineEnum.MXNet);
    }
